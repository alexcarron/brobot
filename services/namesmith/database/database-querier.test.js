...
describe('DatabaseQuerier', () => {
  ...
  describe('.getQuery()', () => {
    it('prepares a SQL query and returns a wrapper object', async () => {
    ...
    it('throws an error if the query is invalid', async () => {
      ...
      expect(() => dbQuerier.getQuery(query)).toThrowError();
    });
  });

  describe('.run()', () => {
    it('runs a single write query and returns the result', async () => {
    ...
    it('throws an error if the query is invalid', async () => {
      const query = 'INVALID QUERY';
      const params = ['character3', 'legendary'];
      expect(() => dbQuerier.run(query, params)).toThrowError();
    });
  });

  describe('.getRow()', () => {
    it('runs a single read query and returns a single row', async () => {
    ...
    it('returns undefined if no row is found', async () => {
      const query = 'SELECT * FROM character WHERE id = ?';
      const params = [999];
      const result = dbQuerier.getRow(query, params);
  ...
  describe('.getRows()', () => {
    it('runs a single read query and returns all rows', async () => {
      const query = 'SELECT * FROM character';
    ...
    it('returns an empty array if no rows are found', async () => {
      const query = 'SELECT * FROM character WHERE id = ?';
      const params = [999];
  ...
  describe('.getIterator()', () => {
    it('runs a single read query and returns an iterator over the result set', async () => {
      const query = 'SELECT * FROM character';
  ...
  describe('.getFirstColumnValues()', () => {
    it('runs a single read query and returns an array of the first column of all rows', async () => {
	...
	describe('.getTransaction()', () => {
		it('creates a transaction of multiple queries and returns a function that starts the transaction when called', async () => {
	...
	describe('.runTransaction()', () => {
		it('runs a transaction of multiple queries and returns the result of the transaction', async () => {
			const queries = [
				'INSERT INTO character (value, rarity) VALUES (?, ?)',
				'INSERT INTO character (value, rarity) VALUES (?, ?)'
			]
