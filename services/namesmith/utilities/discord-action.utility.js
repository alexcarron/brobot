...
const { fetchPublishedNamesChannel, fetchNamesmithGuildMember } = require("./discord-entity.utility");
...
module.exports = { changeDiscordNameOfPlayer, sendToPublishedNamesChannel };