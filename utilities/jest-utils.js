 ...
 * @param {Function} defineTestsOrSubgroups - The function that defines all the related tests or sub-groups of tests.
 * @example
 * groupTests('addition', () => {
 ...
 * @param {Function} defineTestsOrSubgroups - The function that defines all the related expected behaviors or sub-groups of expected behaviors.
 * @example
 ...
 * @param {Function} defineEntitiesTesting - The function that defines all the entities being tested.
 * @example
 ...
 * @param {Function} runTestScenario - A function that runs the test scenario.
 */
 ...
 * @param {Function} functionToRun - The function to run before each test.
 * @example
 * runBeforeEach(() => {
 *   initializeTestState();
 * })
 ...
 * @param {Function} functionToRun - The function to run after each test.
 * @example
 * runAfterEach(() => {
 *   cleanupTestState();
 * })
 ...
 * @param {Function} functionToRun - The function to run after all tests.
 * @example
 * runAfterAllTests(() => {
 *   cleanUpResources();
 * })
 ...
 * @param {Function} functionToRun - The function to run before all tests.
 * @example
 * runBeforeAllTests(() => {
 *   setupResources();
 * })
 ...
 * @property {(...args: any[]) => import('@jest/expect').Matchers} [key: string]
 *   All the methods from Jest's expect are included dynamically.
 ...
 * @property {import('@jest/expect').Matchers} turnsOut
...
function makeSure(actualValue) {
  ...
  return {
		 ...
		 * @param {Class} expectedClass - The class that the actual value should be an instance of
		 * @example
     ...
     * @returns {import('@jest/expect').Matchers} The original Jest expect matcher for this value.
     * @example
